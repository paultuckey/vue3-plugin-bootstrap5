<template>
  <div>
      ...
      <div class="mb-4">
          ...
          <button v-vb-toggle:offcanvas="'offcanvasExample'"
                  class="btn btn-primary" type="button" aria-controls="offcanvasExample">
              Button
          </button>

          <div v-vb-is:offcanvas ref="offcanvasExample"
      ...
      <div class="mb-4">
          ...
          <button v-vb-toggle:offcanvas data-bs-target="#offcanvasExample"
                  class="btn btn-primary" type="button" aria-controls="offcanvasExample">
              Button
          </button>

          <div v-vb-is:offcanvas id="offcanvasExample"
